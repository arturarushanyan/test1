 ...
 */
angular.module('vbet5.betting').controller('dashboardCtrl', ['$rootScope', '$scope', '$location', 'Config', 'Zergling', 'Moment', function ($rootScope, $scope, $location, Config, Zergling, Moment) {
    'use strict';
