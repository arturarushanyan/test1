...
VBET5.directive('flashplayer', ['$window', '$timeout', '$rootScope', 'Translator', function ($window, $timeout, $rootScope, Translator) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            if (providerId === '21' || providerId === '22' || providerId === '23' || providerId === '24' ) { // for dota and windbet stream we must show streams in iframe
                var frame = angular.element('<iframe  src="'+streamUrl+'" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>');
