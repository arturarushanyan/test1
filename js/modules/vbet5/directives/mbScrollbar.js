...
VBET5.directive('mbScrollbar', function() {
    'use strict';
        ...
        link: function(scope, element) {
            ...
            scope.styles = {
                scrollbar: {
                    ...
                    'border-radius': config.scrollbar.width  + 'px'
                },
                scrollbarContainer: {
                    position: 'absolute',
            ...
            scrollbarContainer.css( config.rPosition , '-4px' );
            ...
            var recalculate = function() {
                ...
                scrollbarLength = ( containerSize / length ) * containerSize - config.scrollbar.margin ;
