        ...
        return {
            ...
            link: function ($scope, $elem, $attrs) {
                $timeout(function () {
                    ...
                    if ($attrs.scrollIf === undefined || $attrs.scrollIf === 'true') {
                        smoothScroll($elem[0], {
...
//
    .factory('smoothScroll', ['$timeout', '$window', function ($timeout, $window) {
        ...
        var smoothScroll = function (element, options) {
            ...
            $timeout(function () {
                ...
                var stopAnimation = function () {
                    ...
                    var horizontalScrollWidth = window.innerWidth >= document.body.scrollWidth ? 0 : 17;
                    if (position == endLocation || currentLocation == endLocation || ( (window.innerHeight + currentLocation) >= document.body.scrollHeight + horizontalScrollWidth )) {
