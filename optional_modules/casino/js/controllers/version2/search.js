 ...
 * Search controller
 */
VBET5.controller('casinoNewSearchCtrl', ['$rootScope', '$scope', '$timeout', '$location', 'Config', 'casinoUtils', 'CConfig', 'casinoData', function ($rootScope, $scope, $timeout, $location, Config, casinoUtils, CConfig, casinoData) {
    'use strict';
    ...
    function doSearchCommand(command) {
        if (command && command.length > 2) {
            casinoData.getGames(null, null, null, null, command).then(function (response) {
